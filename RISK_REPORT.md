...
_Generated 2026-08-28. Energy-Charts FR day-ahead prices; daily maximum series._

## What is market data and what is an assumption?

| item | value | type |
|---|---:|---|
| Latest observed daily peak price | €221.22/MWh | market data |
| 30-day volatility of daily price changes | €65.36/MWh | calculated from market data |
...
| metric | value |
|---|---:|
| Latest daily peak | €221.22/MWh |
| 30-day standard deviation of daily price changes | €65.36/MWh |
...
|---|---:|---:|
| long 100 MWh | €10,751 | €15,205 |

Under the model assumptions, there is approximately a 5% probability that the one-day loss exceeds **€10,751**.
...
| Maximum portfolio 95% VaR | €10,000 | €10,751 | **BREACH** |
...
- Forecast demand: **39.03 GW**
- Forecast nuclear generation: **33.50 GW**
- Forecast residual demand: **-10.85 GW**
- Forecast daily peak price: **€89.07/MWh**
