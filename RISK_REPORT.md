...
_Generated 2026-09-17. Energy-Charts FR day-ahead prices; daily maximum series._

## What is market data and what is an assumption?

| item | value | type |
|---|---:|---|
| Latest observed daily peak price | €270.22/MWh | market data |
| 30-day volatility of daily price changes | €32.50/MWh | calculated from market data |
...
| metric | value |
|---|---:|
| Latest daily peak | €270.22/MWh |
| 30-day standard deviation of daily price changes | €32.50/MWh |
| 90-day standard deviation of daily price changes | €54.22/MWh |
...
|---|---:|---:|
| long 100 MWh | €5,346 | €7,561 |

Under the model assumptions, there is approximately a 5% probability that the one-day loss exceeds **€5,346**.
...
| Maximum portfolio 95% VaR | €10,000 | €5,346 | OK |

## Position sizing

The VaR formula permits **187 MWh**; the separate volume limit permits **2,000 MWh**.

The binding maximum is therefore **187 MWh**.

## Latest model forecast

- Target date: **2026-09-18**
- Forecast demand: **43.16 GW**
- Forecast nuclear generation: **38.89 GW**
- Forecast residual demand: **-7.50 GW**
- Forecast daily peak price: **€123.70/MWh**
