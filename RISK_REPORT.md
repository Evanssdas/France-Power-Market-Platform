...
_Generated 2026-07-19. Energy-Charts FR day-ahead prices; daily maximum series._

## What is market data and what is an assumption?

| item | value | type |
|---|---:|---|
| Latest observed daily peak price | €168.41/MWh | market data |
| 30-day volatility of daily price changes | €59.85/MWh | calculated from market data |
...
| metric | value |
|---|---:|
| Latest daily peak | €168.41/MWh |
| 30-day standard deviation of daily price changes | €59.85/MWh |
| 90-day standard deviation of daily price changes | €42.81/MWh |
...
|---|---:|---:|
| long 100 MWh | €9,844 | €13,923 |

Under the model assumptions, there is approximately a 5% probability that the one-day loss exceeds **€9,844**.
...
| Maximum portfolio 95% VaR | €10,000 | €9,844 | OK |

## Position sizing

The VaR formula permits **102 MWh**; the separate volume limit permits **2,000 MWh**.

The binding maximum is therefore **102 MWh**.

## Latest model forecast

- Target date: **2026-07-20**
- Forecast demand: **44.90 GW**
- Forecast nuclear generation: **40.12 GW**
- Forecast residual demand: **-9.99 GW**
- Forecast daily peak price: **€122.33/MWh**
