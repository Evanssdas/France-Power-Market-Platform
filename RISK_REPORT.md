...
_Generated 2026-09-16. Energy-Charts FR day-ahead prices; daily maximum series._

## What is market data and what is an assumption?

| item | value | type |
|---|---:|---|
| Latest observed daily peak price | €287.04/MWh | market data |
| 30-day volatility of daily price changes | €32.32/MWh | calculated from market data |
...
| metric | value |
|---|---:|
| Latest daily peak | €287.04/MWh |
| 30-day standard deviation of daily price changes | €32.32/MWh |
| 90-day standard deviation of daily price changes | €54.18/MWh |
...
|---|---:|---:|
| long 100 MWh | €5,316 | €7,518 |

Under the model assumptions, there is approximately a 5% probability that the one-day loss exceeds **€5,316**.
...
| Maximum portfolio 95% VaR | €10,000 | €5,316 | OK |

## Position sizing

The VaR formula permits **188 MWh**; the separate volume limit permits **2,000 MWh**.

The binding maximum is therefore **188 MWh**.

## Latest model forecast

- Target date: **2026-09-17**
- Forecast demand: **43.62 GW**
- Forecast nuclear generation: **37.94 GW**
- Forecast residual demand: **-6.38 GW**
- Forecast daily peak price: **€145.37/MWh**
