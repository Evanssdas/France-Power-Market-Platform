...
_Generated 2026-09-13. Energy-Charts FR day-ahead prices; daily maximum series._

## What is market data and what is an assumption?

| item | value | type |
|---|---:|---|
| Latest observed daily peak price | €213.63/MWh | market data |
| 30-day volatility of daily price changes | €47.79/MWh | calculated from market data |
...
| metric | value |
|---|---:|
| Latest daily peak | €213.63/MWh |
| 30-day standard deviation of daily price changes | €47.79/MWh |
| 90-day standard deviation of daily price changes | €53.12/MWh |
...
|---|---:|---:|
| long 100 MWh | €7,861 | €11,118 |

Under the model assumptions, there is approximately a 5% probability that the one-day loss exceeds **€7,861**.
...
| Maximum portfolio 95% VaR | €10,000 | €7,861 | OK |

## Position sizing

The VaR formula permits **127 MWh**; the separate volume limit permits **2,000 MWh**.

The binding maximum is therefore **127 MWh**.

## Latest model forecast

- Target date: **2026-09-14**
- Forecast demand: **45.60 GW**
- Forecast nuclear generation: **40.68 GW**
- Forecast residual demand: **-6.25 GW**
- Forecast daily peak price: **€173.01/MWh**
