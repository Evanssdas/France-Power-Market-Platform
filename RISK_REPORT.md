...
_Generated 2026-07-28. Energy-Charts FR day-ahead prices; daily maximum series._

## What is market data and what is an assumption?

| item | value | type |
|---|---:|---|
| Latest observed daily peak price | €187.05/MWh | market data |
| 30-day volatility of daily price changes | €36.23/MWh | calculated from market data |
...
| metric | value |
|---|---:|
| Latest daily peak | €187.05/MWh |
| 30-day standard deviation of daily price changes | €36.23/MWh |
| 90-day standard deviation of daily price changes | €43.13/MWh |
...
|---|---:|---:|
| long 100 MWh | €5,959 | €8,428 |

Under the model assumptions, there is approximately a 5% probability that the one-day loss exceeds **€5,959**.
...
| Maximum portfolio 95% VaR | €10,000 | €5,959 | OK |

## Position sizing

The VaR formula permits **168 MWh**; the separate volume limit permits **2,000 MWh**.

The binding maximum is therefore **168 MWh**.

## Latest model forecast

- Target date: **2026-07-29**
- Forecast demand: **47.50 GW**
- Forecast nuclear generation: **41.33 GW**
- Forecast residual demand: **-8.20 GW**
- Forecast daily peak price: **€162.56/MWh**
