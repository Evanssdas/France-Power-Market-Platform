...
_Generated 2026-07-21. Energy-Charts FR day-ahead prices; daily maximum series._

## What is market data and what is an assumption?

| item | value | type |
|---|---:|---|
| Latest observed daily peak price | €186.34/MWh | market data |
| 30-day volatility of daily price changes | €59.96/MWh | calculated from market data |
...
| metric | value |
|---|---:|
| Latest daily peak | €186.34/MWh |
| 30-day standard deviation of daily price changes | €59.96/MWh |
| 90-day standard deviation of daily price changes | €42.89/MWh |
...
|---|---:|---:|
| long 100 MWh | €9,863 | €13,950 |

Under the model assumptions, there is approximately a 5% probability that the one-day loss exceeds **€9,863**.
...
| Maximum portfolio 95% VaR | €10,000 | €9,863 | OK |

## Position sizing

The VaR formula permits **101 MWh**; the separate volume limit permits **2,000 MWh**.

The binding maximum is therefore **101 MWh**.

## Latest model forecast

- Target date: **2026-07-22**
- Forecast demand: **45.61 GW**
- Forecast nuclear generation: **40.65 GW**
- Forecast residual demand: **-9.03 GW**
- Forecast daily peak price: **€131.20/MWh**
