...
_Generated 2026-07-27. Energy-Charts FR day-ahead prices; daily maximum series._

## What is market data and what is an assumption?

| item | value | type |
|---|---:|---|
| Latest observed daily peak price | €147.98/MWh | market data |
| 30-day volatility of daily price changes | €38.41/MWh | calculated from market data |
...
| metric | value |
|---|---:|
| Latest daily peak | €147.98/MWh |
| 30-day standard deviation of daily price changes | €38.41/MWh |
| 90-day standard deviation of daily price changes | €43.00/MWh |
...
|---|---:|---:|
| long 100 MWh | €6,317 | €8,935 |

Under the model assumptions, there is approximately a 5% probability that the one-day loss exceeds **€6,317**.
...
| Maximum portfolio 95% VaR | €10,000 | €6,317 | OK |

## Position sizing

The VaR formula permits **158 MWh**; the separate volume limit permits **2,000 MWh**.

The binding maximum is therefore **158 MWh**.

## Latest model forecast

- Target date: **2026-07-28**
- Forecast demand: **45.67 GW**
- Forecast nuclear generation: **40.34 GW**
- Forecast residual demand: **-7.08 GW**
- Forecast daily peak price: **€174.69/MWh**
