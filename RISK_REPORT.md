...
_Generated 2026-07-25. Energy-Charts FR day-ahead prices; daily maximum series._

## What is market data and what is an assumption?

| item | value | type |
|---|---:|---|
| Latest observed daily peak price | €204.95/MWh | market data |
| 30-day volatility of daily price changes | €49.11/MWh | calculated from market data |
...
| metric | value |
|---|---:|
| Latest daily peak | €204.95/MWh |
| 30-day standard deviation of daily price changes | €49.11/MWh |
| 90-day standard deviation of daily price changes | €42.79/MWh |
...
|---|---:|---:|
| long 100 MWh | €8,078 | €11,425 |

Under the model assumptions, there is approximately a 5% probability that the one-day loss exceeds **€8,078**.
...
| Maximum portfolio 95% VaR | €10,000 | €8,078 | OK |

## Position sizing

The VaR formula permits **124 MWh**; the separate volume limit permits **2,000 MWh**.

The binding maximum is therefore **124 MWh**.

## Latest model forecast

- Target date: **2026-07-26**
- Forecast demand: **38.41 GW**
- Forecast nuclear generation: **36.16 GW**
- Forecast residual demand: **-9.76 GW**
- Forecast daily peak price: **€107.02/MWh**
