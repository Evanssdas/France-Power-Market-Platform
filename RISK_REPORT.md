...
_Generated 2026-08-04. Energy-Charts FR day-ahead prices; daily maximum series._

## What is market data and what is an assumption?

| item | value | type |
|---|---:|---|
| Latest observed daily peak price | €201.97/MWh | market data |
| 30-day volatility of daily price changes | €30.24/MWh | calculated from market data |
...
| metric | value |
|---|---:|
| Latest daily peak | €201.97/MWh |
| 30-day standard deviation of daily price changes | €30.24/MWh |
| 90-day standard deviation of daily price changes | €43.33/MWh |
...
|---|---:|---:|
| long 100 MWh | €4,975 | €7,036 |

Under the model assumptions, there is approximately a 5% probability that the one-day loss exceeds **€4,975**.
...
| Maximum portfolio 95% VaR | €10,000 | €4,975 | OK |

## Position sizing

The VaR formula permits **201 MWh**; the separate volume limit permits **2,000 MWh**.

The binding maximum is therefore **201 MWh**.

## Latest model forecast

- Target date: **2026-08-05**
- Forecast demand: **45.83 GW**
- Forecast nuclear generation: **39.84 GW**
- Forecast residual demand: **-7.44 GW**
- Forecast daily peak price: **€136.62/MWh**
